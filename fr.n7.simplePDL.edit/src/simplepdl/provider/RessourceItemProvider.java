...
public class RessourceItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addWdneedPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Wdneed feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addWdneedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_wdneed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_wdneed_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__WDNEED,
				 true,
				 false,
				 true,
				 null,
