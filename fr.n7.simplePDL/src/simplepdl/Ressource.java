 ...
 *   <li>{@link simplepdl.Ressource#getWdneed <em>Wdneed</em>}</li>
 * </ul>
 *
...
public interface Ressource extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Wdneed</b></em>' reference list.
	 * The list contents are of type {@link simplepdl.WDNeed}.
	 * It is bidirectional and its opposite is '{@link simplepdl.WDNeed#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Wdneed</em>' reference list.
	 * @see simplepdl.SimplepdlPackage#getRessource_Wdneed()
	 * @see simplepdl.WDNeed#getRessource
	 * @model opposite="ressource"
	 * @generated
	 */
	EList<WDNeed> getWdneed();
