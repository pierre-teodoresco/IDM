...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass wdNeedEClass = null;
	 ...
	 */
	@Override
	public EReference getRessource_Wdneed() {
	 ...
	 */
	@Override
	public EAttribute getWDNeed_Quantity() {
		return (EAttribute)wdNeedEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getWDNeed_Ressource() {
		return (EReference)wdNeedEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(ressourceEClass, RESSOURCE__WDNEED);

		wdNeedEClass = createEClass(WD_NEED);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, simplepdl.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Wdneed(), this.getWDNeed(), this.getWDNeed_Ressource(), "wdneed", null, 0, -1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(wdNeedEClass, WDNeed.class, "WDNeed", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
