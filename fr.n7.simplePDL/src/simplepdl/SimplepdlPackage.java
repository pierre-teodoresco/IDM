...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Wdneed</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE__WDNEED = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.WDNeedImpl <em>WD Need</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.WDNeedImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getWDNeed()
	 * @generated
	 */
	int WD_NEED = 6;
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getWdneed <em>Wdneed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Wdneed</em>'.
	 * @see simplepdl.Ressource#getWdneed()
	 * @see #getRessource()
	 * @generated
	 */
	EReference getRessource_Wdneed();

	/**
	 * Returns the meta object for class '{@link simplepdl.WDNeed <em>WD Need</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>WD Need</em>'.
	 * @see simplepdl.WDNeed
	 * @generated
	 */
	EClass getWDNeed();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.WDNeed#getQuantity <em>Quantity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantity</em>'.
	 * @see simplepdl.WDNeed#getQuantity()
	 * @see #getWDNeed()
	 * @generated
	 */
	EAttribute getWDNeed_Quantity();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.WDNeed#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource</em>'.
	 * @see simplepdl.WDNeed#getRessource()
	 * @see #getWDNeed()
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see simplepdl.WDNeed#getName()
	 * @see #getWDNeed()
	 * @generated
	 */
	EAttribute getWDNeed_Name();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Wdneed</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCE__WDNEED = eINSTANCE.getRessource_Wdneed();

		/**
		 * The meta object literal for the '{@link simplepdl.impl.WDNeedImpl <em>WD Need</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.WDNeedImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getWDNeed()
		 * @generated
		 */
		EClass WD_NEED = eINSTANCE.getWDNeed();
		 ...
		 * @generated
		 */
		EAttribute WD_NEED__QUANTITY = eINSTANCE.getWDNeed_Quantity();
		 ...
		 * @generated
		 */
		EAttribute WD_NEED__NAME = eINSTANCE.getWDNeed_Name();
